...
TOWN = "Town03"
TM_PORT = 8000
JUNCTION_ID = 1352  # 3-way junction in Town03

MODEL_DIR = "2_RL_Models_3WAY_RGCNN_SEED_42"
...
def main():
    ...
    os.makedirs("2_Logs_RGCNN_3_WAY", exist_ok=True)
    csv_file = f"2_Logs_RGCNN_3_WAY/ppo_3way_metrics_RGCNN_withSC_seed_42_{MODEL_EPISODE}.csv"
    ...
    draw_radius_circle(world, intersection_loc, radius=23.0,
                       color=carla.Color(255, 0, 255), z_offset=0.2)
    draw_direction_lines(world, intersection_loc, ["E","N","S"], length=30.0, z=2.0)
