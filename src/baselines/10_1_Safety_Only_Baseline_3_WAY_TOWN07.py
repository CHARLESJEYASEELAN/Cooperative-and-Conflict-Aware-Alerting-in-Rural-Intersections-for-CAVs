...
def configure_traffic_manager(tm, vehicles):
    for vehicle in vehicles:
        ...
        tm.distance_to_leading_vehicle(vehicle, 1.0) #was 2.0
...
def main():
    ...
    '''
    csv_file = f"10_1_Safety_Only_Baseline_NEW_3WAY_metrics.csv"
    ...
    #draw_direction_lines(world, intersection_loc, ["S", "E", "W"], length=30.0, z=2.0)
